...
const int CFGV_DEFAULT_SERVER_LISTENQUEUE_LENGTH = 100;
...
const int CFGV_DEFAULT_SERVER_WORKER_COUNT = 3;
const char * const CFG_SERVER_CONSUMER_COUNT = "consumer_count";
